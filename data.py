...
class CornellMovieCorpusProcessor:
    ...
    def __init__(self, lines='cornell_movies/movie_lines.txt',
	 			conversations='cornell_movies/movie_conversations.txt'):
